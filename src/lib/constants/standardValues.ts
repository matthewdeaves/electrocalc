// E12 series resistor values (10% tolerance)
export const E12_SERIES = [
  1.0, 1.2, 1.5, 1.8, 2.2, 2.7, 3.3, 3.9, 4.7, 5.6, 6.8, 8.2
]

// E24 series resistor values (5% tolerance)
...
// Common resistor decades
export const RESISTOR_DECADES = [1, 10, 100, 1000, 10000, 100000, 1000000, 10000000]

/**
 * Find the nearest standard resistor value
 */
export function findNearestStandardValue(
  value: number,
  series: number[] = E24_SERIES
): { value: number; formatted: string } {
  if (value <= 0) return { value: 0, formatted: '0Ω' }

  // Find the appropriate decade
  const decade = Math.pow(10, Math.floor(Math.log10(value)))
  const normalizedValue = value / decade
  ...
  const result = nearest * decade
  return { value: result, formatted: formatResistance(result) }
}
